...
const List<CreatureSpec> prehistoricCreatures = <CreatureSpec>[
  ...
  CreatureSpec(
    ...
    palette: CreaturePalette(
      body: Color(0xFF8A7A5C),
      belly: Color(0xFFD8C8A8),
      accent: Color(0xFFB8A382),
      detail: Color(0xFF5C503A),
    ),
    body: BodyShape.wide,
  ...
  CreatureSpec(
    ...
    tier: 5,
    palette: CreaturePalette(
      body: Color(0xFF8A6E4E),
      belly: Color(0xFFD8BC94),
      accent: Color(0xFFC49E72),
      detail: Color(0xFF5C462E),
    ),
    body: BodyShape.serpent,
    ears: EarType.antenna,
    eyes: EyeStyle.round,
  ...
  CreatureSpec(
    ...
    tier: 9,
    palette: CreaturePalette(
      body: Color(0xFF4E4A5C),
      belly: Color(0xFF9E98B4),
      accent: Color(0xFF6ECFD8),
      detail: Color(0xFF2E2B3A),
    ),
    body: BodyShape.bird,
  ...
  CreatureSpec(
    ...
    tier: 15,
    palette: CreaturePalette(
      body: Color(0xFFD8C48A),
      belly: Color(0xFFF7EDCF),
      accent: Color(0xFFB8A25C),
      detail: Color(0xFF8A7A42),
    ),
    body: BodyShape.tall,
    tail: TailType.long,
  ...
  CreatureSpec(
    ...
    tier: 19,
    palette: CreaturePalette(
      body: Color(0xFF8A8A72),
      belly: Color(0xFFD8D4B8),
      accent: Color(0xFF6E6E56),
      detail: Color(0xFFB8B294),
    ),
  ...
  CreatureSpec(
    ...
    tier: 20,
    palette: CreaturePalette(
      body: Color(0xFF9E8A6E),
      belly: Color(0xFFE0D0B4),
      accent: Color(0xFF6E8A5C),
  ...
  CreatureSpec(
    ...
    tier: 21,
    palette: CreaturePalette(
      body: Color(0xFFC4A08A),
      belly: Color(0xFFEFDCC8),
      accent: Color(0xFFE07A5C),
      detail: Color(0xFF8A6450),
    ),
    body: BodyShape.bird,
    ears: EarType.horn,
  ...
  CreatureSpec(
    ...
    tier: 29,
    palette: CreaturePalette(
      body: Color(0xFF9E6E4E),
      belly: Color(0xFFDCB894),
      accent: Color(0xFFC48A62),
      detail: Color(0xFFEFE3CE),
    ),
    body: BodyShape.chunky,
    ears: EarType.roundSmall,
